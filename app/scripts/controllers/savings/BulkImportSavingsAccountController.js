(function (module) {
    mifosX.controllers = _.extend(module, {
        BulkImportSavingsAccountController: function (scope, resourceFactory, location, API_VERSION, $rootScope, Upload) {
            ...
            scope.first = {};
            scope.first.templateUrl =  API_VERSION + '/savingsaccounts/bulkimporttemplate' + '?tenantIdentifier=' + $rootScope.tenantIdentifier
            ...
            scope.upload = function () {
                Upload.upload({
                    url: $rootScope.hostUrl + API_VERSION + '/savingsaccounts/bulkuploadtemplate',
