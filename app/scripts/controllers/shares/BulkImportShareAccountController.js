(function (module) {
    mifosX.controllers = _.extend(module, {
        BulkImportShareAccountController: function (scope, resourceFactory, location, API_VERSION, $rootScope, Upload) {
            ...
            scope.first = {};
            scope.first.templateUrl =  API_VERSION + '/accounts/share/bulkimporttemplate' + '?tenantIdentifier=' + $rootScope.tenantIdentifier
            ...
            scope.upload = function () {
                Upload.upload({
                    url: $rootScope.hostUrl + API_VERSION + '/accounts/share/bulkuploadtemplate',
